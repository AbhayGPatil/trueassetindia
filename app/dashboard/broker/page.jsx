...
export default function BrokerDashboard() {
  ...
  const handleDeleteProperty = async (propertyId) => {
    ...
    try {
      ...
      window.alert('Unable to delete property: ' + err.message);
    }
  };
                  ...
                  <div className={styles.propContent}>
                    ...
                    <div className={styles.propMeta}>
                      <span className={styles.propType}>
                        {prop.type === 'auction' || prop.bankAuction ? 'Bank Auction' : (prop.type === 'sell' ? 'For Sale' : 'For Rent')}
                      </span>
                      {prop.isVerified && (
                    ...
                    <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' }}>
                      <button 
                        onClick={() => router.push(`/dashboard/broker/edit-property/${prop.id}`)}
          ...
          {interestedClients.length === 0 ? (
            ...
            <div className={styles.interestedTable}>
              <div className={styles.tableHead}>
                ...
                <div className={styles.tableCol3}>Property</div>
